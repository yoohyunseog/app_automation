...
def open_codepen_page():
    # 드라이버 실행 및 페이지 열기
    driver = get_driver(headless=False)
    url = "file:///E:/Ai%20project/nb_wfa/naver_influencer_crawler/gpt-content-v-0-5/dist/index.html"
    driver.get(url)
...
def open_codepen_Courses_page():
    # 드라이버 실행 및 페이지 열기
    driver = get_driver(headless=False)
    url = "file:///E:/Ai%20project/nb_wfa/naver_influencer_crawler/gpt-open_codepen_courses_page-v-0-5/dist/index.html"
    driver.get(url)
    print(f"✅ CodePen 페이지 열림: {url}")
